...
class vgg19:
	...
	def conv_layers(self, features, phase, batch_norm, input_channel=3):
		...
		self.conv4_4, kernel, biases = self.conv_layer(self.conv4_2, 'conv4_4', [3, 3, 512, 512], phase, batch_norm)
		self.conv_parameters += [kernel, biases]
        ...
        # conv5_4 new
		self.conv5_4, kernel, biases = self.conv_layer(self.conv5_3, 'conv5_4', [3, 3, 512, 512], phase, batch_norm)
		self.conv_parameters += [kernel, biases]
